...
/*   Updated: 2023/01/21 16:18:59 by frmessin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	Hit record; 
	Because maybe it is easier if we store the t and some information about 
	the hit.
...
t_vec3			get_surface_normal(t_object *obj,
					t_vec3 hitpoint, t_light *light);
#endif